...
class BitmartAdapter(BaseVendorAdapter):
    """
    Template adapter for Bitmart Exchange API.

    Replace all occurrences of:
    - 'BitmartAdapter' with '[ExchangeName]Adapter' (e.g., 'BybitAdapter')
    - 'Bitmart' with actual exchange name (e.g., 'Bybit')
    - 'https://api.bitmart.com' with actual REST API base URL
    - 'wss://ws-manager-compress.bitmart.com' with actual WebSocket URL
    ...
    def discover_products(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if not isinstance(symbols_data, list):
                ...
                raise Exception(f"Unexpected response format from Bitmart")
